...
u32 anim_color_blend(const u32 color_from, const u32 color_to, const u16 frame, const u16 frame_count, const float speed,
	...
	u8 r1 = (color_from >> 16) & 0b11111111;
	u8 g1 = (color_from >> 8) & 0b11111111;
	u8 b1 = color_from & 0b11111111;
	u8 r2 = (color_to >> 16) & 0b11111111;
	u8 g2 = (color_to >> 8) & 0b11111111;
	u8 b2 = color_to & 0b11111111;

	u8 r_diff = r1 < r2 ? r2 - r1 : r1 - r2;
	u8 g_diff = g1 < g2 ? g2 - g1 : g1 - g2;
	u8 b_diff = b1 < b2 ? b2 - b1 : b1 - b2;

	r_diff = utils_min(utils_proportional_reduce(r_diff, adjusted_frame, divisor), 255);
	g_diff = utils_min(utils_proportional_reduce(g_diff, adjusted_frame, divisor), 255);
	b_diff = utils_min(utils_proportional_reduce(b_diff, adjusted_frame, divisor), 255);
